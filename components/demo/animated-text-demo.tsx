    ...
    <Card className="w-full min-h-[600px] shadow-inner">
      <div className="flex h-full" style={{ minHeight: "inherit" }}>
        ...
        <div className="flex-1 p-6 min-w-[50%]">
          <h3 className="font-semibold mb-4">Animated</h3>
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-4">
        <h2 className="text-2xl font-bold mb-2">Chunk to Character Animation</h2>
        <p className="text-muted-foreground">Left side animates by chunks (paragraphs), right side by character</p>
      </div>
...
export function ChunkToWordDemo() {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-4">
        <h2 className="text-2xl font-bold mb-2">Chunk to Word Animation</h2>
        <p className="text-muted-foreground">Left side animates by chunks (paragraphs), right side by word</p>
      </div>
